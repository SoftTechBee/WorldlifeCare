...
public partial class Admin_rptMachingIncome : System.Web.UI.Page
{
    ...
    private void loadlist()
    {
        try
        {
            string sql = "select r.name,r.doa,r.dateofjoin,a.username,sum(cast (a.credit as decimal(18,2))) as totalincome from register r inner join dbo.account a on r.username=a.username  where a.valu='REWARD' ";
