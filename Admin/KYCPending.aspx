<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="KYCPending.aspx.cs" Inherits="Admin_KYCPending" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Pending KYC List</h4>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class=" form-group row align-items-center mb-3">
                    ...
                    <div class="col-md-2 col-xs-6 col-lg-3">
                        <asp:Button ID="btnSeach" runat="server" Text="Search" CssClass="btn btn-primary w-lg bg-gradient" OnClick="btnSeach_Click" />
                    </div>
                </div>
                <br />
