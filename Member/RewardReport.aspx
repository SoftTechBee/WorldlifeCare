<%@ Page Title="" Language="C#" MasterPageFile="~/Member/MasterPage.master" AutoEventWireup="true" CodeFile="RewardReport.aspx.cs" Inherits="User_rptLevelIncome" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Reward Report</h4>
            </div>
        </div>
    </div>
    <hr />
