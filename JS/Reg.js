    ...
    methods: {
        invest() {
            ...
            tronWeb.trx.getBalance(metaMaskAddress).then(function (walletbalance) {
                ...
                var BasicPrice = 50;// document.getElementById("lbtotaltrx").innerHTML;
                var AmtDollar = 50;// $("#txtamt").val();
                var IDAmt = 50;//document.getElementById("lbtotaltrx").innerHTML;
                // alert(BasicPrice);
                //alert(AmtDollar);
                // alert('h1');
              //  var BasicPrice = 1;// Math.round(parseInt(BasicPrice) + 20);
                if (AmtDollar >= 1) {
                    ...
                    alert('Amount should be greater than 60 TRX ');
                    ...
                    async function checkTransactionStatus(transactionHash) {
                        ...
                        if (transaction.ret[0].contractRet === 'SUCCESS') {
                            ...
                            $.ajax({
                                ...
                                data: "{'tron_amount':'" + AmtDollar + "','sponsor':'" + userid + "' ,'tron_ac':'" + metaMaskAddress + "','tron_transactionId':'" + transactionHash + "'}",
