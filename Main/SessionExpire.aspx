...
<head  runat="server">
    ...
    <title>Session Expire - Pages |  UP TO Financial Freedom</title>

    <meta name="description" content="Success isn't given, it's built. Build yours by starting your business today." />
    <meta name="keywords" content="vdesk, business vdesk, Session ">
    <!-- Canonical SEO -->
...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    ...
    <p class="mb-4 mx-2">Admin! 😖 You're being timed out due to inactivity..</p>
    <a href="Login.aspx" class="btn btn-primary">Back to Admin Login</a>
    <div class="mt-3">
